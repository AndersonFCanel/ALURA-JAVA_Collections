...
/*O implements comparable serve para implementar a comparação de Aulas, note que o método compareTo
 *  foi reescrito possibilitando a comparação por nome, se não fosse assim o compareTo não saberia comparar uma aula a outra
 *  */
...
public class Aula implements Comparable<Aula> {
	...
	/*
	 * Reescrevendo nosso toString para trabalhar bem com a lista Vamos então
	 * reescrever nosso método toString da classe Aula, para que ele retorne algo
	 * significativo:
	 */
	// Como Aula é um objeto e tem diversas propriedades(Atributos) esse tipo de
	// sobrescrita do
